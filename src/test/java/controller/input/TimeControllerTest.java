...
class TimeControllerTest {
    ...
    /*
     * @Test
     * void handleTimerCompleteEmitsPositiveEndscreenIfAlgaeLevelHigh() throws
     * Exception {
     ...
     * verify(emitter,
     * atLeastOnce()).emitGameStateChange(GameState.ENDSCREEN_POSITIVE);
     * }
     * 
     * @Test
     * void handleTimerCompleteEmitsNegativeEndscreenIfAlgaeLevelLow() throws
     * Exception {
