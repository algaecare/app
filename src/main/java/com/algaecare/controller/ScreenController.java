...
public class ScreenController implements GameStateChangeListener {
    ...
    private void initializeLayers() {
        ...
        TextLayer titleTextLayer = new TextLayer(1040, 220, 450, 125, TextLayerData.getText("TITLE"), "SUPERWATER_BIG");
        layers.add(titleTextLayer);

        TextLayer subtitleTextLayer = new TextLayer(450, 100, 775, 350, TextLayerData.getText("SUBTITLE"),
                "SUPERWATER_SMALL");
